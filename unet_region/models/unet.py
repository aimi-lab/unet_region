...
class DownConv(nn.Module):
    ...
    def __init__(self,
        ...
        self.addcoords, self.in_channels = make_addcoords(self.in_channels,
                                                          with_coordconv,
                                                          with_coordconv_r)
        ...
        self.conv1_bn = nn.BatchNorm2d(self.out_channels)
...
class UpConv(nn.Module):
    ...
    def forward(self, from_down, from_up):
        ...
        if(self.addcoords is not None):
            from_up = self.addcoords(from_up)
    ...
    def __init__(self,
        ...
        for i in range(depth):
            ...
            down_conv = DownConv(ins,
                                 outs,
                                 pooling=pooling,
                                 with_coordconv=with_coordconv,
                                 with_coordconv_r=with_coordconv_r,
                                 with_batchnorm=with_batchnorm).to(self.device)
